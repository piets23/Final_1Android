...
public class AllPlayersList_Adapter extends ArrayAdapter<Players>
{
    private Context context;
    private List<Players> players;

    public AllPlayersList_Adapter(Context context, List<Players> playersList )
    {
        super(context, R.layout.activity_all_players_list_,playersList);
